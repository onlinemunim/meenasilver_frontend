...
@Component({
  selector: 'app-retail-stock-list-list',
  standalone: true,
  imports: [CommonModule, FormsModule, NgFor, NgIf, RouterLink],
  templateUrl: './retail-stock-list-list.component.html',
  styleUrls: ['./retail-stock-list-list.component.css'] // <-- Change from styleUrl to styleUrls (plural)
})

export class RetailStockListListComponent implements OnInit {
