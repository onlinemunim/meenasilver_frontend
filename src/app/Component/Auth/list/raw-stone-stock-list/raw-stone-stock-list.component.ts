...
@Component({
  selector: 'app-raw-stone-stock-list',
  standalone: true,
  imports: [CommonModule, FormsModule, NgFor, NgIf, RouterLink],
  templateUrl: './raw-stone-stock-list.component.html',
  styleUrls: ['./raw-stone-stock-list.component.css'] // <-- Change from styleUrl to styleUrls (plural)
})

export class RawStoneStockListComponent implements OnInit {
