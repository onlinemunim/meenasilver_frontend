...
@Component({
  selector: 'app-wholesale-search-list',
  imports: [CommonModule], // Import CommonModule to use *ngFor
  templateUrl: './wholesale-search-list.component.html',
  styleUrl: './wholesale-search-list.component.css'
})
export class WholesaleSearchListComponent {
