...
@Component({
  selector: 'app-immitation-sterling-jewellery-panel-list',
  standalone: true,
  imports: [CommonModule, FormsModule, NgFor, NgIf, RouterLink],
  templateUrl: './immitation-sterling-jewellery-panel-list.component.html',
  styleUrls: ['./immitation-sterling-jewellery-panel-list.component.css'] // <-- Change from styleUrl to styleUrls (plural)
})

export class ImmitationSterlingJewelleryPanelListComponent implements OnInit {
  ...
  selectedFields = [
    ...
    { key: 'Search Gross Weight(GM)', label: 'Gross Weight(GM)', selected: true }
  ];
