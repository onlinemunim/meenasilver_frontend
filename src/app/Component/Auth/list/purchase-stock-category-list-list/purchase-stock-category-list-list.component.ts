...
@Component({
  selector: 'app-purchase-stock-category-list-list',
  standalone: true,
  imports: [CommonModule, FormsModule, NgFor, NgIf, RouterLink],
  templateUrl: './purchase-stock-category-list-list.component.html',
  styleUrls: ['./purchase-stock-category-list-list.component.css'] // <-- Change from styleUrl to styleUrls (plural)
})

export class PurchaseStockCategoryListListComponent  implements OnInit {
