...
@Component({
  selector: 'app-sold-out-stock-list2-list',
  standalone: true,
  imports: [CommonModule, FormsModule, NgFor, NgIf, RouterLink],
  templateUrl: './sold-out-stock-list2-list.component.html',
  styleUrls: ['./sold-out-stock-list2-list.component.css'] // <-- Change from styleUrl to styleUrls (plural)
})

export class SoldOutStockList2ListComponent implements OnInit {
  ...
  selectedFields = [
    ...
    { key: 'Search STONE', label: 'Stone', selected: true },
    { key: 'Search MKG', label: 'Mkg', selected: true },
    { key: 'Search VAL', label: 'Val', selected: true },
    { key: 'Search TAX', label: 'Tax', selected: true },
    { key: 'Search TOTAL', label: 'Total', selected: true },
    { key: 'Search LOCATION', label: 'Location', selected: true },
    { key: 'Search HUID', label: 'Huid', selected: true },
    { key: 'Search COUNTER', label: 'Counter', selected: true }
  ];
