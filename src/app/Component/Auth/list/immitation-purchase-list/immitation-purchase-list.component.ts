...
@Component({
  selector: 'app-immitation-purchase-list',
  standalone: true,
  imports: [CommonModule, FormsModule, NgFor, NgIf, RouterLink],
  templateUrl: './immitation-purchase-list.component.html',
  styleUrls: ['./immitation-purchase-list.component.css'] // <-- Change from styleUrl to styleUrls (plural)
})

export class ImmitationPurchaseListComponent implements OnInit {
  ...
  selectedFields = [
    ...
    { key: 'Search Dicounted Price', label: 'Dicounted Price', selected: true },
