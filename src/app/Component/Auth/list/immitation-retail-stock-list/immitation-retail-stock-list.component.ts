...
@Component({
  selector: 'app-immitation-retail-stock-list',
  standalone: true,
  imports: [CommonModule], // Import CommonModule to use *ngFor
  templateUrl: './immitation-retail-stock-list.component.html',
  styleUrls: ['./immitation-retail-stock-list.component.css']
})
export class ImmitationRetailStockListComponent {
