...
@Component({
  selector: 'app-sold-out-stock-list',
  imports: [CommonModule], // Import CommonModule to use *ngFor
  templateUrl: './sold-out-stock-list.component.html',
  styleUrl: './sold-out-stock-list.component.css'
})
export class SoldOutStockListComponent {
