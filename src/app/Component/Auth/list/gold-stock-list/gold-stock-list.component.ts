...
@Component({
  selector: 'app-gold-stock-list',
  standalone: true,
  imports: [CommonModule, FormsModule, NgFor, NgIf, RouterLink],
  templateUrl: './gold-stock-list.component.html',
  styleUrls: ['./gold-stock-list.component.css'] // <-- Change from styleUrl to styleUrls (plural)
})

export class GoldStockListComponent implements OnInit {
