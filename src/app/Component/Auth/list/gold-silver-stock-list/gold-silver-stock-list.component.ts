...
@Component({
  selector: 'app-gold-silver-stock-list',
  standalone: true,
  imports: [CommonModule, FormsModule, NgFor, NgIf, RouterLink],
  templateUrl: './gold-silver-stock-list.component.html',
  styleUrls: ['./gold-silver-stock-list.component.css'] // <-- Change from styleUrl to styleUrls (plural)
})

export class GoldSilverStockListComponent implements OnInit {
