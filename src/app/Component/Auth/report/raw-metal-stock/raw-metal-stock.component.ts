...
@Component({
  ...
  styleUrl: './raw-metal-stock.component.css'
})
export class RawMetalStockComponent implements OnInit {
  ...
  getRawMetalList() {
    this.rawmetalservice.getRawMetalEntries().subscribe((response: any) => {
      if (response?.data?.length) {
        this.rawMetallist = response.data.reverse()
  ...
  selectedFields = [
    ...
    { key: 'st_subunit', label: 'Per Piece Wt', selected: true },
    { key: 'st_total_wt', label: 'Total Weight', selected: true },
    { key: 'st_quantity', label: 'Quantity', selected: true },
    { key: 'st_metal_rate', label: 'Silver Rate', selected: true },
    { key: 'st_unit_price', label: 'Per piece Silver', selected: true },
    { key: 'st_per_gm_labour', label: 'Per Gram Labour', selected: true },
    { key: 'st_per_piece_labour', label: 'Per piece Labour', selected: true },
    { key: 'st_per_gm_shipping', label: 'Per Gram Shiping', selected: true },
    { key: 'st_per_piece_shipping', label: 'Per Piece shipping ', selected: true },
    { key: 'st_sub_unit_price', label: 'Per piece Total', selected: true }
  ];
  ...
  restoreColumnSelection() {
    ...
    this.selectedFields = [
      ...
      { key: 'st_per_gm_labour', label: 'Per Gram Labour', selected: true },
      { key: 'st_per_piece_labour', label: 'Per piece Labour', selected: true },
      { key: 'st_per_gm_shipping', label: 'Per Gram Shiiping', selected: true },
      { key: 'st_per_piece_shipping', label: 'Per Piece shipping ', selected: true },
      { key: 'st_sub_unit_price', label: 'Per piece Total', selected: true }
    ];
    this.filterTable();
