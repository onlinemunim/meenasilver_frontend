...
@Component({
  selector: 'app-add-metal-form-b2',
  standalone: true,
  imports: [
  ...
  templateUrl: './add-metal-form-b2.component.html',
  styleUrl: './add-metal-form-b2.component.css'
})
export class AddMetalFormB2Component implements OnInit, AfterViewInit{
