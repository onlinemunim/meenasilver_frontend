...
@Component({
  ...
  templateUrl: './add-cad-stock.component.html',
  styleUrl: './add-cad-stock.component.css'
})
export class AddCadStockComponent implements OnInit, AfterViewInit{
