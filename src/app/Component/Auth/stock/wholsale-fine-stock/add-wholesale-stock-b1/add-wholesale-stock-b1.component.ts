...
@Component({
  selector: 'app-add-wholesale-stock-b1',
  standalone: true,
  imports: [
  ...
  templateUrl: './add-wholesale-stock-b1.component.html',
  styleUrl: './add-wholesale-stock-b1.component.css'
})
export class AddWholesaleStockB1Component implements OnInit, AfterViewInit{
