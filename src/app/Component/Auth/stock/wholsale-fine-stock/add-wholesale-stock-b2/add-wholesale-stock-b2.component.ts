...
@Component({
  selector: 'app-add-wholesale-stock-b2',
  standalone: true,
  imports: [
  ...
  templateUrl: './add-wholesale-stock-b2.component.html',
  styleUrl: './add-wholesale-stock-b2.component.css'
})
export class AddWholesaleStockB2Component implements OnInit, AfterViewInit{
