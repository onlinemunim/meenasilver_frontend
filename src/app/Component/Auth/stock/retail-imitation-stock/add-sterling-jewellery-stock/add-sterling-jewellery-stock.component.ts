...
@Component({
  ...
  templateUrl: './add-sterling-jewellery-stock.component.html',
  styleUrls: ['./add-sterling-jewellery-stock.component.css']
})
export class AddSterlingJewelleryStockComponent implements OnInit , AfterViewInit {
