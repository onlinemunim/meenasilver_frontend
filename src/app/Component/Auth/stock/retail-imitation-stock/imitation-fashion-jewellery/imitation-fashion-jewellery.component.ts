...
@Component({
  selector: 'app-imitation-fashion-jewellery',
  standalone: true,
  imports: [
  ...
  templateUrl: './imitation-fashion-jewellery.component.html',
  styleUrls: ['./imitation-fashion-jewellery.component.css']
})
export class ImitationFashionJewelleryComponent implements OnInit, AfterViewInit
  {
