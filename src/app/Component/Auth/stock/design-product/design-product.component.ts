...
@Component({
  ...
  imports: [NgIf, NgFor,NgSwitch,NgSwitchDefault,NgSwitchCase, FormsModule, RouterLink],
  templateUrl: './design-product.component.html',
  styleUrl: './design-product.component.css',
})
export class DesignProductComponent implements OnInit {
  ...
  ngOnInit(): void {
    const savedSelections = localStorage.getItem('designProductColumnSelections');
    if (savedSelections) {
