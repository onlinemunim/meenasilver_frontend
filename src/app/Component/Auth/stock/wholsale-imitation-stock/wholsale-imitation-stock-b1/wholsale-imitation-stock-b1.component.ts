...
@Component({
  selector: 'app-wholsale-imitation-stock-b1',
  standalone: true,
  imports: [
  ...
  templateUrl: './wholsale-imitation-stock-b1.component.html',
  styleUrls: ['./wholsale-imitation-stock-b1.component.css']
})
export class WholsaleImitationStockB1Component implements OnInit, AfterViewInit {
