...
@Component({
  ...
  selector: 'app-wholsale-imitation-add-sterling-jewellery-stock',
  standalone: true,
  imports: [
  ...
  templateUrl: './wholsale-imitation-add-sterling-jewellery-stock.component.html',
  styleUrls: ['./wholsale-imitation-add-sterling-jewellery-stock.component.css']
})
export class WholsaleImitationAddSterlingJewelleryStockComponent implements OnInit, AfterViewInit {
