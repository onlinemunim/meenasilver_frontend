...
@Component({
  ...
  selector: 'app-wholsale-imitation-fashion-jewellery',
  standalone: true,
  imports: [
  ...
  templateUrl: './wholsale-imitation-fashion-jewellery.component.html',
  styleUrls: ['wholsale-imitation-fashion-jewellery.component.css']
})
export class WholsaleImitationFashionJewelleryComponent implements OnInit, AfterViewInit {
