...
@Component({
  ...
  selector: 'app-wholsale-imitation-stock-b2',
  standalone: true,
  imports: [
  ...
  templateUrl: './wholsale-imitation-stock-b2.component.html',
  styleUrls: ['./wholsale-imitation-stock-b2.component.css']
})
export class WholsaleImitationStockB2Component implements OnInit, AfterViewInit {
