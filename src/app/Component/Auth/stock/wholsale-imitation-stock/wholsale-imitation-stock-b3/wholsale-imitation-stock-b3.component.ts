...
@Component({
  ...
  selector: 'app-wholsale-imitation-stock-b3',
  standalone: true,
  imports: [
  ...
  templateUrl: './wholsale-imitation-stock-b3.component.html',
  styleUrls: ['./wholsale-imitation-stock-b3.component.css']
})
export class WholsaleImitationStockB3Component implements OnInit, AfterViewInit {
